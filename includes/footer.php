...
<footer class="footer mt-auto py-3 bg-dark text-white">
    <div class="mdx-section">
        ...
        <div class="col-12 col-md-3 d-box">
                ...
                <p class="text-muted small-text mdx-footer-text mdx-foot-toes">
...
from across the country, offering a diverse range of quality items at unbeatable prices.                </p>
            ...
            <div class="col-12 col-md-3 d-box">
                ...
                <ul class="list-unstyled footer-links">
                    <li><a href="/auction_guide.php" class="text-muted mdx-footer-text">Auction Guide</a></li>
                    <li><a href="/transport_services.php" class="text-muted mdx-footer-text">Transport Services</a></li>
                    <li><a href="/sell_with_us.php" class="text-muted mdx-footer-text">Sell With Us</a></li>
                    <li><a href="/faq.php" class="text-muted mdx-footer-text">FAQ</a></li>
                </ul>
            </div>
            <div class="col-12 col-md-3 d-box">
                <h5 class="footer-heading">Contact Us</h5>
                <ul class="list-unstyled contact-info text-muted">
                    <li class="mdx-footer-text"><i class="fas fa-map-marker-alt"></i> Kampala, Uganda</li>
                    <li class="mdx-footer-text"><i class="fas fa-phone"></i> +256 756 027 405</li>
                    <li class="mdx-footer-text"><i class="fas fa-envelope"></i> info@kwetuauctions.com</li>
                </ul>
            </div>
            <div class="col-12 col-md-3 d-box">
