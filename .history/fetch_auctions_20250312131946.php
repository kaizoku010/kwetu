...
// Make sure this path is correct relative to fetch_auctions.php
require_once './includes/db.php';  // or require_once __DIR__ . '/includes/db.php';

// Define $isAdmin before use
