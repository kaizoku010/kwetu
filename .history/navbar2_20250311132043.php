...
/* Button color change when collapsed */
.sidebar.collapsed .collapse-toggle {
    background: #28a745; /* Green color when collapsed */
}
...
/* Ensure dropdowns are positioned correctly when collapsed */
.hover-dropdown ul {
    left: 100%;
    top: 0;
}
...
.sidebar.collapsed .hover-dropdown ul {
    left: 60px; /* Adjust based on collapsed width */
}
</style>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Your existing JavaScript for fetching bids and data
    let userId = <?php echo json_encode($user_id); ?>;
