            ...
            const cards = [
                `<div class="col-md-4 mdx-promos">
                    ...
                    <div class="auction-details promo-details">
                            ...
                            <p style="font-size:small">EXPERT INSIGHTS</p>
                            <h4 class="promo">WHAT IS A FAIR PRICE?</h4>
                            <p style="font-size:small">From the desk of Sam Kwetu</p>
                            </div>
                ...
                `<div class="col-md-4 mdx-promos">
                    ...
                    <div class="auction-details promo-details">
                            ...
                            <a href="/new-arrivals" class="promo-link">View Latest</a>
                        </div>
                ...
                `<div class="col-md-4 mdx-promos">
                    ...
                    <div class="auction-details promo-details">
                            ...
                            <a href="/ending-soon" class="promo-link">Bid Now</a>
                        </div>
