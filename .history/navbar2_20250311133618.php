...
<style>
    ...
    .toggle-btn {
        ...
        right: -40px;
        top: 20px;
        background: #212529;  /* Dark color when open */
        border: none;
        color: white;
        padding: 10px;
        cursor: pointer;
    ...
    /* Change color to green when sidebar is collapsed */
    .sidebar.collapsed .toggle-btn {
        background: #f7951d;  /* Bootstrap's green color */
    }
...
<nav class="col-md-3 col-lg-2-m d-md-block bg-dark sidebar">
    <button class="toggle-btn">
        <i class="fas fa-chevron-left">◀ pull me</i>
    </button>
